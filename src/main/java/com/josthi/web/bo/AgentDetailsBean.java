...
public class AgentDetailsBean {
	...
	public String toString() {
		return "AgentDetailsBean [uid=" + uid + ", firstName=" + firstName + ", middleName=" + middleName
				+ ", lastName=" + lastName + ", gender=" + gender + ", userAddressFirstLine=" + userAddressFirstLine
				...
				+ instagramLink + ", comments=" + comments + ", agencyName=" + agencyName + ", agencyDescription="
				+ agencyDescription + ", userStatus=" + userStatus + "]";
	}
