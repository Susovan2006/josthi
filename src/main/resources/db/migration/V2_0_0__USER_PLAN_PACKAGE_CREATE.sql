...
CREATE TABLE `josthi_db`.`price_breakup_offer` (
  `OFFER_ID` INT NOT NULL AUTO_INCREMENT,
  `PLAN_START_DATE` DATETIME NOT NULL,
  `PLAN_END_DATE` DATETIME NOT NULL,
  `PLAN_NAME` VARCHAR(45) NOT NULL,
  `PLAN_DURATION_CODE` VARCHAR(20) NOT NULL,
  `PLAN_BENEFICIARY_COUNT_CODE` VARCHAR(20) NULL,
  `BREAKUP_REQUESTED_BY` VARCHAR(15) NULL,
  `BREAKUP_REQUESTED_FOR` VARCHAR(100) NULL,
  `PLAN_PRICE_PER_PERSON_PER_MONTH` VARCHAR(20) NULL,
  `BENEFECICIARY_COUNT_TO_DISPLAY` VARCHAR(100) NULL,
  `BASE_PRICE_FOR_TOTAL_BENEFECIARY` VARCHAR(20) NULL,
  `DISCOUNTED_PRICE_FOR_TOTAL_BENEFECIARY` VARCHAR(20) NULL,
  `PLAN_DURATION_TO_DISPLAY` VARCHAR(20) NULL,
  `DISCOUNT_PERCENTAGE_FOR_FAMILY_PLAN` VARCHAR(20) NULL,
  `BASE_PRICE_FOR_SELECTED_DURATION` VARCHAR(20) NULL,
  `DISCOUNTED_PRICE_FOR_SELECTED_DURATION` VARCHAR(20) NULL,
  `FINAL_DISCOUNTED_PRICE` VARCHAR(20) NULL,
  `TOTAL_GAIN` VARCHAR(45) NULL,
  `BREAKUP_CREATED_ON` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`OFFER_ID`));
  
  
  
  CREATE TABLE `josthi_db`.`agentfeedback` (
  `FID` INT NOT NULL AUTO_INCREMENT,
  `FEEDBACK_FOR` VARCHAR(200) NULL,
  `FEEDBACK_BY` VARCHAR(20) NULL,
  `PROACTIVENESS` DECIMAL(2,2) NOT NULL DEFAULT 0.00,
  `RESPONSIBILITY` DECIMAL(2,2) NOT NULL DEFAULT 0.00,
  `AVAILABILITY` DECIMAL(2,2) NOT NULL DEFAULT 0.00,
  `BEHAVIOR` DECIMAL(2,2) NOT NULL DEFAULT 0.00,
  `CARE_AND_HANDLING` DECIMAL(2,2) NOT NULL DEFAULT 0.00,
  `OVERALL_RATING` DECIMAL(2,2) NOT NULL DEFAULT 0.00,
  `AREA_OF_IMPROVEMENT` VARCHAR(1000) NULL,
  `OTHER_COMMENTS` VARCHAR(500) NULL,
  `FEEDBACK_DATE` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`FID`));
  
  
  
  CREATE TABLE `josthi_db`.`josthi_feedback` (
  `FID` INT NOT NULL AUTO_INCREMENT,
  `FEEDBACK_BY` VARCHAR(20) NULL,
  `SUGGESTIONS_NOTES` VARCHAR(500) NULL,
  `FEEDBACK_DATE` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  `ACTION_TAKEN` VARCHAR(100) NULL,
  PRIMARY KEY (`FID`));
  
  
  CREATE TABLE `josthi_db`.`customer_enquery` (
  `ENQID` INT NOT NULL AUTO_INCREMENT,
  `CUSTOMER_NAME` VARCHAR(200) NULL,
  `CUSTOMER_EMAIL` VARCHAR(200) NULL,
  `MESSAGE` VARCHAR(100) NULL,
  `ENQUERY_DATE` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ENQID`));