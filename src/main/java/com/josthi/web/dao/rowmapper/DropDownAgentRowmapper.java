...
public class DropDownAgentRowmapper implements RowMapper<DropDownBean> {
	...
	public DropDownBean mapRow(ResultSet resultSet,int arg1)throws SQLException {
		...
		dropDownBean.setKeyId(resultSet.getString("CUSTOMER_ID"));
		dropDownBean.setValue(resultSet.getString("FIRST_NAME")+" "+resultSet.getString("LAST_NAME")+ "-"+resultSet.getString("ZIP_PIN"));
