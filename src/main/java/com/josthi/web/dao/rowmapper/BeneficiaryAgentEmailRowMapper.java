...
public class BeneficiaryAgentEmailRowMapper implements RowMapper<AgentAssignmentBean> {
	...
	public AgentAssignmentBean mapRow(ResultSet resultSet, int rowNum) throws SQLException {
		...
		//agentAssignmentBean.setHostUserEmail(resultSet.getString("HOST_EMAIL"));
