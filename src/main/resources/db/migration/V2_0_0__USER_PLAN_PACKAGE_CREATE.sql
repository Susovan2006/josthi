...
ADD COLUMN `ONDEMAND_IMAGE` VARCHAR(200) NULL AFTER `ICON`,
ADD COLUMN `ONDEMAND_RATING` DECIMAL(10,2) NULL AFTER `ONDEMAND_IMAGE`,
ADD COLUMN `ONDEMAND_INFO` VARCHAR(200) NULL AFTER `ONDEMAND_RATING`;
